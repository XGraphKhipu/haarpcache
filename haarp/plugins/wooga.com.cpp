...
// regex
// http.*\.wooga\.com.*(\.jpg|\.png|\.swf|\.mp3)
...
extern "C" resposta hgetmatch2(const string url) {
    resposta r;
	 r.range_min = r.range_max = 0;
        ...
        if ( (url.find(".wooga.com/") != string::npos) and (url.find(".jpg") != string::npos) or (url.find(".png") != string::npos) or (url.find(".swf") != string::npos) or (url.find(".mp3") != string::npos)
        ) {
